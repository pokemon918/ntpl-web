const {sortedIndexBy, difference, intersection} = _;
...
class Autosuggest {
	constructor(data) {
		...
		for (let item of data) {
			...
			// improves performance by 20% - disabled because it ruins the display of suggestions
			// item.data.filter_value = Object.values(item.data).join(',');
